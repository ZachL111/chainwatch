"""Regression checks for the chainwatch casebook."""
...
from casebook.harness import assert_expected, chainwatch_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(chainwatch_summary(), assert_expected())
