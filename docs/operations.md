...
`chainwatch` is centered on blockchain tooling work in Go. The technical target is: Detect reorgs, finality thresholds, and watcher alerts.
...
The score is deterministic. The current threshold is 168. Risk has a penalty of 5, latency has a penalty of 2, and weight contributes a bonus of 4.
